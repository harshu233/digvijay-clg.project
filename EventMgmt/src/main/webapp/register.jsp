...
<head>
  <meta charset="utf-8">
  <title>Register | The Event Hub Pune</title>
...
<body>
  <div class="register-box">
    ...
    <form method="post" action="RegisterServlet" onsubmit="return validateRegister()">
      <div class="mb-3">
        <label>Name</label>
      ...
      <button class="btn-register mt-3"><span>Register</span></button>

      <div class="extra-links">
        <p class="mt-3 mb-1">Already have an account? <a href="login.jsp">Login</a></p>
